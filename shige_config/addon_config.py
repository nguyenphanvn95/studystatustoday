...
THE_ADDON_NAME = "Format Study Status Today"
SHORT_ADDON_NAME = "Format Study Status Today"
RATE_THIS = None
...
RATE_THIS_URL = f"https://ankiweb.net/"
...
class MyAddonConfig(QDialog):
    def __init__(self, parent=None):
        ...
        if RATE_THIS:
            button3 = QPushButton('👍️Anki Addons')
            button3.clicked.connect(self.open_rate_this_Link)
            mini_button(button3)

        button4 = QPushButton("💖Google")
        ...
        tab_widget.addTab(reviewer_tab, "Thiết lập")
